...
from .crop_kg import CropKGSearchTool
from .evidence import EvidenceSearchTool
from .germplasm import GermplasmSearchTool
...
AGENT_TOOLS: dict[str, set[str]] = {
    "breeding_designer": {
        ...
        "germplasm_search", "crop_kg_search", "evidence_search",
...
class ToolRegistry:
    ...
    def discover(self) -> ToolRegistry:
        ...
        for t in (
            ...
            GermplasmSearchTool(self._cfg),
            CropKGSearchTool(self._cfg),
            EvidenceSearchTool(self._cfg),
