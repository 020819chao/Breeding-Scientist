...
NEVER_DEGRADE = {"risk_reviewer.verification", "iteration_orchestrator.final"}


@dataclass
class ModelRoute:
    agent: str
    mode: str         # e.g. "breeding_designer.literature"
    model: str
...
def thinking_budget_for(cfg: Config, mode: str) -> int:
    ...
    th = cfg.thinking
    return {
        "breeding_designer.literature": th.breeding_designer_literature,
        "breeding_designer.debate": th.breeding_designer_debate,
        "breeding_designer.combine": th.route_combine,
        "breeding_designer.out_of_box": th.route_out_of_box,
        "breeding_designer.feasibility": th.route_feasibility,
        "breeding_designer.simplify": th.route_simplify,
        "risk_reviewer.evidence_review": th.risk_reviewer_evidence,
        "risk_reviewer.verification": th.verification_review,
        "risk_reviewer.observation": th.observation_review,
        "iteration_orchestrator.pairwise": th.pairwise_calibration,
        "iteration_orchestrator.debate": th.calibration_debate,
        "iteration_orchestrator.system": th.iteration_feedback,
        "iteration_orchestrator.final": th.final_synthesis,
        "iteration_orchestrator.final_repair": th.final_synthesis,
    }.get(mode, 0)
...
def route(cfg: Config, agent: str, mode: str | None = None, *, degraded: bool = False) -> ModelRoute:
    ...
    m = cfg.models
    model = {
        ("breeding_designer", "literature"): m.breeding_designer,
        ("breeding_designer", "debate"): m.breeding_designer,
        ("breeding_designer", "combine"): m.breeding_designer_revision,
        ("breeding_designer", "out_of_box"): m.breeding_designer_revision,
        ("breeding_designer", "feasibility"): m.breeding_designer_revision,
        ("breeding_designer", "simplify"): m.breeding_designer_revision,
        ("risk_reviewer", "evidence_review"): m.risk_reviewer_evidence,
        ("risk_reviewer", "verification"): m.risk_reviewer_evidence,
        ("risk_reviewer", "observation"): m.risk_reviewer_evidence,
        ("iteration_orchestrator", "pairwise"): m.pairwise_calibration,
        ("iteration_orchestrator", "debate"): m.calibration_debate,
        ("iteration_orchestrator", "priority"): m.composite_prioritization,
        ("iteration_orchestrator", "system"): m.iteration_feedback,
        ("iteration_orchestrator", "final"): m.final_synthesis,
        ("iteration_orchestrator", "final_repair"): m.final_synthesis,
        ("parse_goal", None):          m.goal_interpreter,
        ("goal_interpreter", None):     m.goal_interpreter,
        ("classifier", None):          m.classifier,
        ("judge", None):               m.judge,
    }.get((agent, mode), m.breeding_designer)
