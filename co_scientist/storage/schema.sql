-- AI Breeding Scientist — SQLite schema (initial)
...
CREATE TABLE IF NOT EXISTS hypotheses (
    ...
    created_at      TEXT NOT NULL,
    created_by      TEXT NOT NULL,                     -- breeding_designer
    ...
    pairwise_calibrations_played   INTEGER NOT NULL DEFAULT 0,
    state           TEXT NOT NULL,                     -- draft|reviewed|calibration_pool|pinned|rejected|quarantined|retired
    dedup_cluster   TEXT
);
...
CREATE TABLE IF NOT EXISTS pairwise_calibration_matches (
    ...
    calibration_a_before    REAL NOT NULL,
    calibration_b_before    REAL NOT NULL,
    calibration_a_after     REAL,
    calibration_b_after     REAL,
    rationale       TEXT,
    transcript_id   TEXT,
    similarity      REAL
);
...
-- Append-only pairwise calibration ledger.
-- UNIQUE on match_id makes calibration updates idempotent.
CREATE TABLE IF NOT EXISTS pairwise_calibration_journal (
    ...
    calibration_a_before    REAL NOT NULL,
    calibration_b_before    REAL NOT NULL,
    calibration_a_after     REAL NOT NULL,
    calibration_b_after     REAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS system_feedback (
    ...
    session_id      TEXT NOT NULL REFERENCES sessions(id) ON DELETE CASCADE,
    created_at      TEXT NOT NULL,
    source          TEXT NOT NULL,                     -- human|iteration_orchestrator
